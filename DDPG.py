...
def main(_):
    with tf.Session() as sess:
        ...
        stats = train(sess, env, actor, critic)

        rewards_polyddpg = pd.Series(stats.episode_rewards).rolling(1, min_periods=1).mean()    
        cum_rwd = rewards_polyddpg

        np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Persistence_Length_Exploration/Results/'  + 'DDPG' + '.npy', cum_rwd)
